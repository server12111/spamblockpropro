...
WITHDRAWAL_CHANNEL  = int(os.getenv('WITHDRAWAL_CHANNEL', '0'))   # ID канала/чата для запросов на вывод
BOT_USERNAME        = os.getenv('BOT_USERNAME', '')                # username главного бота (без @)
